...
|----------|-----------|------|
| Coverage breadth over depth in month 1 | 850 good articles beats 500 perfect ones for topical authority | Feb 2026 (inherited from CEO, target revised Feb 21) |
...
| **Writer restart Feb 26 6PM UTC, 1 writer limit** | Founder directive Feb 21 — extended from Feb 22. Only need ~70 articles to hit 850 target. | Feb 21, 2026 (founder directive) |
