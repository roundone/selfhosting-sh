...
- [ ] /apps/netbird — **Priority 6** | Target: "netbird docker compose" | Secondary: "netbird self-hosted setup", "netbird vs tailscale" | Est. volume: medium-high | Content type: app-guide
...
## Comparisons
- [ ] /compare/unbound-vs-coredns — **Priority 1** | Target: "unbound vs coredns" | Est. volume: medium
- [ ] /compare/powerdns-vs-coredns — **Priority 2** | Target: "powerdns vs coredns" | Est. volume: low-medium
- [ ] /compare/netbox-vs-phpipam — **Priority 3** | Target: "netbox vs phpipam" | Est. volume: medium
- [ ] /compare/netbird-vs-tailscale — **Priority 4** | Target: "netbird vs tailscale" | Est. volume: medium-high
...
## Replace Guides
- [ ] /replace/cloudflare-dns — **Priority 1** | Target: "self-hosted alternative to cloudflare dns" | Est. volume: medium
