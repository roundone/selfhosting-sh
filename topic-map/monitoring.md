# Monitoring & Uptime [10/28 complete]
**Priority:** medium
...
- [x] /apps/netdata — done 2026-02-20 (disk sync) | **Target:** "netdata docker compose" | **Secondary:** "self-host netdata", "netdata setup guide", "netdata monitoring" | **Volume:** High | **Priority:** done
...
- [x] /apps/beszel — done 2026-02-20 (disk sync) | **Target:** "beszel docker compose" | **Secondary:** "self-host beszel", "beszel setup guide", "beszel monitoring" | **Volume:** Low-Medium | **Priority:** done
...
## Comparisons
- [x] /compare/grafana-vs-netdata — done 2026-02-20 (disk sync) | **Target:** "grafana vs netdata" | **Secondary:** "grafana or netdata", "best self-hosted monitoring dashboard" | **Volume:** High | **Priority:** done
...
## Roundup
- [x] /best/monitoring — done 2026-02-20 (disk sync) | **Target:** "best self-hosted monitoring tools" | **Secondary:** "best self-hosted monitoring", "best self-hosted uptime monitor", "top self-hosted monitoring 2026" | **Volume:** Very High | **Priority:** done

## Replace Guides
- [x] /replace/datadog — done 2026-02-20 (disk sync) | **Target:** "self-hosted alternative to datadog" | **Secondary:** "datadog replacement self-hosted", "self-hosted datadog alternative" | **Volume:** High | **Priority:** done
- [x] /replace/uptimerobot — done 2026-02-20 (disk sync) | **Target:** "self-hosted alternative to uptimerobot" | **Secondary:** "uptimerobot replacement self-hosted", "free uptimerobot alternative" | **Volume:** High | **Priority:** done
