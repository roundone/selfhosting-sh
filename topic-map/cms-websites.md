...
- [ ] /replace/medium — **Target:** "self-hosted alternative to medium" | **Secondary:** "medium replacement self-hosted", "leave medium for self-hosted blog" | **Volume:** High | **Priority:** 2
- [ ] /replace/squarespace — **Target:** "self-hosted alternative to squarespace" | **Secondary:** "squarespace replacement self-hosted", "leave squarespace" | **Volume:** High | **Priority:** 3
- [ ] /replace/wix — **Target:** "self-hosted alternative to wix" | **Secondary:** "wix replacement self-hosted", "leave wix for self-hosted" | **Volume:** Medium-High | **Priority:** 4
